...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        self.outputFolderPath = '/home/xingpeng/Project/Interface_Demo/UI_work/output/'
        self.imgNum = 0
        self.imgIdx = 0
        self.pix = QPixmap()
    ...
    def runDemoClicked(self):
        ...
        run_IG_UI(model_location=self.modelPath, img_folder=self.folderPath, output_folder=self.outputFolderPath)

        self.statusInfo.setText('Running Grad CAM ...')
        Grad_CAM_UI(model_location=self.modelPath, img_folder=self.folderPath, output_folder=self.outputFolderPath)

        self.statusInfo.setText('Running test ...')
        v_array, v_number = run_test_UI(model_location=self.modelPath, img_folder=self.folderPath)
