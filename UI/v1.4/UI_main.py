...
def UI_main(model_path, img_path):
    config = ConfigProto()
    config.gpu_options.allow_growth = True
    session = InteractiveSession(config=config)

    model_path_1cut = model_path + '1cut.hdf5'
    model_path_4cut = model_path + '4cut.hdf5'
    model_path_16cut = model_path + '16cut.hdf5'
    svm14_path = model_path + 'svm_model_14.pkl'
    svm416_path = model_path + 'svm_model_416.pkl'
    ...
    for img_name in imglist:
        ...
        if os.path.isfile(image_path):
            ...
            heat_mask_path = heatmap_dir + img_name
...
a, b, c = UI_main('/media/xiejun/data1/keras_resnet/UI/model/', '/media/xiejun/data1/keras_resnet/UI/test_img/')
print(a)
print(b)
print(c)